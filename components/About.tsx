...
import { BiGlobe, BiHeart, BiPalette, BiRocket, BiUser } from 'react-icons/bi'
            ...
            <div className="relative flex flex-col-reverse lg:flex-row mt-20 gap-20">
                ...
                <div className="w-full lg:w-3/5 bg-white px-5 py-4 sm:p-10 rounded-2xl">
                    <div className="flex flex-col items-center">
                        <h2 className="text-[32px] md:text-[40px] lg:text-[64px] text-center">About Me</h2>
                        <span className="text-[20px] text-center border-l-[2px] border-black_background pl-4 w-max">Deepak Thangella</span>
                    </div>

                    <div className="flex flex-col justify-center items-center mt-10 gap-10">
                        <div className="flex items-center gap-4 w-full sm:max-w-[60%] flex-wrap md:flex-nowrap border-b-[1px] border-light_gray_2 pb-5">
                            <IconButtons Icon={BiUser} classStyle="rounded-lg w-max" innerClassStyle="rounded-lg" iconClassStyle="w-9 h-9" />
                            <p>Creative professional with 3 years of experience in learning and developing web applications</p>
                        </div>

                        <div className="flex items-center gap-4 w-full sm:max-w-[60%] flex-wrap md:flex-nowrap border-b-[1px] border-light_gray_2 pb-5">
                            <IconButtons Icon={BsTools} classStyle="rounded-lg w-max" innerClassStyle="rounded-lg" iconClassStyle="w-9 h-9" />
                            <p>Expertise in web development, specifically front-end, full-stack, and UI component development</p>
                        </div>

                        <div className="flex items-center gap-4 w-full sm:max-w-[60%] flex-wrap md:flex-nowrap border-b-[1px] border-light_gray_2 pb-5">
                            <IconButtons Icon={BiHeart} classStyle="rounded-lg w-max" innerClassStyle="rounded-lg" iconClassStyle="w-9 h-9" />
                            <p>Passionate about creating innovative designs, providing great user experience, and trying out new web design fundamentals</p>
                        </div>

                        <div className="flex gap-4 w-full sm:w-[60%] flex-wrap md:flex-nowrap border-b-[1px] border-light_gray_2 pb-5">
                            <IconButtons Icon={FaGraduationCap} classStyle="rounded-lg w-max h-max" innerClassStyle="rounded-lg" iconClassStyle="w-9 h-9" />
                        ...
                        <div className="flex items-center gap-4 w-full sm:max-w-[60%] flex-wrap md:flex-nowrap border-b-[1px] border-light_gray_2 pb-5">
                            <IconButtons Icon={BiRocket} classStyle="rounded-lg w-max" innerClassStyle="rounded-lg" iconClassStyle="w-9 h-9" />
                            <p>Driven by a commitment to quality, collaboration, and continuous learning</p>
                        </div>

                        <span className="text-[20px] sm:text-[32px] font-bold">Feel free to connect!</span>
                    </div>
                </div>
            </div>
        </div>
