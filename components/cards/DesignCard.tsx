        ...
        <div className="absolute top-0 left-0 w-full h-full bg-black/30 p-3">
          <div className="flex justify-end items-center w-full gap-3">
            <Link
              href={project.github}
              target="_blank"
              className="bg-white rounded-lg p-1 active:scale-95 hover:bg-mainbackground_gray transition duration-100"
            >
        ...
        <Tooltip>
          <TooltipTrigger className="w-full">
            <div className="flex flex-col gap-3 p-3">
              <h3 className="text-[16px] sm:text-[24px] text-wrap line-clamp-1 truncate">
                {project.title}
              </h3>
              <p className="hidden text-[16px] text-wrap line-clamp-4 truncate">
                {project.description}
              </p>
            </div>
          </TooltipTrigger>
