  ...
  return (
    <div className="flex flex-col gap-2 bg-mainbackground_gray w-full max-w-[350px] max-h-[500px] rounded-md overflow-hidden border border-light_gray_3">
        ...
        <div className="absolute top-0 left-0 w-full h-full bg-black/30 p-3">
          <div className="flex justify-end items-center w-full gap-3">
            <Link
              href={project.github}
              target="_blank"
              className="bg-white rounded-lg p-1 active:scale-95 hover:bg-mainbackground_gray transition duration-100 border-[2px] border-black_background"
            >
      ...
      <div className="flex flex-col gap-3 p-3">
        <h3 className="text-[24px] text-wrap line-clamp-1 truncate">
          {project.title}
        </h3>
        <HoverCard>
          <HoverCardTrigger>
            <p className="text-[16px] text-wrap line-clamp-4 truncate">
              {project.description}
            </p>
          </HoverCardTrigger>
      ...
      <div className="flex flex-col mt-auto px-3 py-2 gap-3">
        ...
        <div className="flex w-full gap-3 border-t-[1px] border-light_gray_3 pt-2">
          <span className="text-[12px] bg-black_background text-white px-3 py-1 rounded-full">
            {project.tag}
          </span>
        </div>
      </div>
